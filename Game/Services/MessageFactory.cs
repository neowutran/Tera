...
namespace Tera.Game
{
    ...
    {
        private static readonly Delegate UnknownMessageDelegate =
            Helpers.Contructor<Func<TeraMessageReader, UnknownMessage>>();

        private static readonly Dictionary<ushort, Delegate> OpcodeNameToType =
            new Dictionary<ushort, Delegate> {{19900, Helpers.Contructor<Func<TeraMessageReader, C_CHECK_VERSION>>()}};
...
//            {"S_GUILD_INFO", Helpers.Contructor<Func<TeraMessageReader,S_GUILD_INFO>>()},
            {"S_TARGET_INFO", Helpers.Contructor<Func<TeraMessageReader, STargetInfo>>()},
            {
                ...
                Helpers.Contructor<Func<TeraMessageReader, StartUserProjectileServerMessage>>()
            },
            ...
            {"S_PARTY_MEMBER_ABNORMAL_DEL", Helpers.Contructor<Func<TeraMessageReader, SPartyMemberAbnormalDel>>()},
            {
                ...
                Helpers.Contructor<Func<TeraMessageReader, SPartyMemberAbnormalRefresh>>()
            },
        ...
        private static readonly Dictionary<string, Delegate> ChatServices = new Dictionary<string, Delegate>
        {
            ...
            {"S_UPDATE_NPCGUILD", Helpers.Contructor<Func<TeraMessageReader, S_UPDATE_NPCGUILD>>()},
            {
                ...
                Helpers.Contructor<Func<TeraMessageReader, S_AVAILABLE_EVENT_MATCHING_LIST>>()
            },
            ...
            {"S_WHISPER", Helpers.Contructor<Func<TeraMessageReader, S_WHISPER>>()},
            {
                ...
                Helpers.Contructor<Func<TeraMessageReader, S_TRADE_BROKER_DEAL_SUGGESTED>>()
            },
            ...
            {"S_FIN_INTER_PARTY_MATCH", Helpers.Contructor<Func<TeraMessageReader, S_FIN_INTER_PARTY_MATCH>>()},
            {
                ...
                Helpers.Contructor<Func<TeraMessageReader, S_BATTLE_FIELD_ENTRANCE_INFO>>()
            },
            {"S_REQUEST_CONTRACT", Helpers.Contructor<Func<TeraMessageReader, S_REQUEST_CONTRACT>>()},
            {
                "S_BEGIN_THROUGH_ARBITER_CONTRACT",
                Helpers.Contructor<Func<TeraMessageReader, S_BEGIN_THROUGH_ARBITER_CONTRACT>>()
            },
        ...
        public MessageFactory(OpCodeNamer opCodeNamer, string region, uint version, bool chatEnabled = false,
        ...
        {
            Delegate type;
            OpcodeNameToType.TryGetValue(opCode, out type);
            if(type == null)
            {
